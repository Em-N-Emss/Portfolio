...
// Détection automatique d'environnement
        ...
        // Méthode 1: Vérifier si on est côté client (navigateur)
        if (typeof window !== "undefined") {
            ...
            // Méthode 3: Vérifier les arguments de la ligne de commande
            const hasServeFlag = process.argv.includes('--serve') || process.argv.includes('serve')

            // Méthode 4: Vérifier le port (Quartz dev utilise généralement 8080)
